...
public interface TaskConfigMapper {
    ...
    @Select("SELECT id, task_code AS taskCode, task_name AS taskName, task_type AS taskType, " +
            "description, icon, sort_order AS sortOrder, is_active AS isActive, extra_config AS extraConfig, " +
    ...
    @Insert("INSERT INTO bp_task_config (task_code, task_name, task_type, description, " +
            "icon, sort_order, is_active, extra_config, created_at, updated_at) " +
            "VALUES (#{taskCode}, #{taskName}, #{taskType}, #{description}, " +
