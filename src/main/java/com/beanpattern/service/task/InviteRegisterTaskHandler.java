...
public class InviteRegisterTaskHandler implements TaskHandler {
    ...
    public InviteRegisterTaskHandler(InviteCodeService inviteCodeService, UserGiftMapper userGiftMapper, BpUserGiftMapper bpUserGiftMapper, GiftPackageService giftPackageService) {
